...
public class FavoriteListFragment extends SherlockFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		m_viewModel = application.getFavListViewModel();
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		//reloadFavorite(m_viewModel.getFavList());
	}
	...
	public void reloadFavorite(List<Board> boardList) {
		if (boardList == null) {
			LoadFavoriteTask loadFavoriteTask = new LoadFavoriteTask(getActivity(),
					m_viewModel);
			...
			for (Iterator<Board> iterator = boardList.iterator(); iterator
					.hasNext();) {
	...
	public void onViewModelChange(BaseViewModel viewModel,
		...
		if (changedPropertyName
				.equals(FavListViewModel.FAVLIST_PROPERTY_NAME)) {
			reloadFavorite(m_viewModel.getFavList());
		}
	}	
}
