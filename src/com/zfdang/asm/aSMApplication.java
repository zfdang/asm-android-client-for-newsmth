...
import com.zfdang.asm.util.CrashHandler;
import com.zfdang.asm.util.MyDatabase;
import com.zfdang.asm.util.SimpleCrypto;
...
public class aSMApplication extends Application {
    ...
    public void initPreferences() {
        ...
        if (lastLaunchVersionCode == 4) {
            try {
                m_autoPassword = SimpleCrypto.encrypt("comzfdangasm", m_autoPassword);
        ...
        try {
            m_autoPassword = SimpleCrypto.decrypt("comzfdangasm", m_autoPassword);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void updateAutoUserNameAndPassword(String username, String password) {
        ...
        try {
            password = SimpleCrypto.encrypt("comzfdangasm", password);
        } catch (Exception e) {
            e.printStackTrace();
        }
