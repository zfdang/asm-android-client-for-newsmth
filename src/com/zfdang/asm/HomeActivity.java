...
import com.zfdang.asm.Adapter.TabsAdapter;
import com.zfdang.asm.data.Board;
import com.zfdang.asm.data.Preferences;
import com.zfdang.asm.fragment.CategoryFragment;
import com.zfdang.asm.fragment.FavoriteListFragment;
import com.zfdang.asm.fragment.GuidanceListFragment;
import com.zfdang.asm.fragment.MailFragment;
import com.zfdang.asm.fragment.ProfileFragment;
import com.zfdang.asm.listener.OnKeyDownListener;
import com.zfdang.asm.service.CheckMessageService;
import com.zfdang.asm.util.StringUtility;
import com.zfdang.asm.util.task.CheckUpdateAsyncTask;
import com.zfdang.asm.util.task.LoginTask;
...
public class HomeActivity extends SherlockFragmentActivity implements OnOpenActivityFragmentListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 如果是第一次启动且没有自动登录
            ...
            intent.setClassName("com.zfdang.asm", "com.zfdang.asm.LoginActivity");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case SETTING:
            Intent intent = new Intent();
            intent.setClassName("com.zfdang.asm", "com.zfdang.asm.SettingActivity");
            startActivity(intent);
            break;
        case REFRESH:
            int index = m_viewPager.getCurrentItem();
    ...
    public void onOpenActivityOrFragment(String target, Bundle bundle) {
        if (target.equals(ActivityFragmentTargets.POST_LIST)) {
            ...
            Intent intent = new Intent();
            intent.putExtras(bundle);
            intent.setClassName("com.zfdang.asm", SubjectListActivity.class.getName());
            startActivity(intent);
        } else if (target.equals(ActivityFragmentTargets.MAIL_LIST)) {
            Intent intent = new Intent();
            intent.putExtras(bundle);
            intent.setClassName("com.zfdang.asm", MailListActivity.class.getName());
            startActivity(intent);
        } else if (target.equals(ActivityFragmentTargets.WRITE_POST)) {
            Intent intent = new Intent();
            intent.putExtras(bundle);
            intent.setClassName("com.zfdang.asm", WritePostActivity.class.getName());
            startActivity(intent);
        }
    }
